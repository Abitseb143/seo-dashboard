...
import HistoryRefreshButton from "@/components/dashboard/HistoryRefreshButton";
              ...
              {history.map((run, i) => (
                <tr key={run.id} className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 font-medium text-slate-800 flex items-center gap-2">
                    ...
                    {formatDate(run.date)}
                    {i === 0 && (
                      <span className="ml-2 text-[10px] bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-bold uppercase">
                        Latest
                      </span>
                    )}
                  </td>
                  <td className="p-4 text-slate-600 font-medium">{run.projectName}</td>
                  ...
                  <td className="p-4 text-center text-slate-600 font-medium">{run.issues}</td>
                  <td className="p-4">
